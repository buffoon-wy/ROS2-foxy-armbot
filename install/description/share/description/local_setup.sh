...
: ${AMENT_CURRENT_PREFIX:="/home/kyxz/dev_ws/install/description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/description/environment/path.sh"
