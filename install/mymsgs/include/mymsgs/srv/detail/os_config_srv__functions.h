...
#ifndef MYMSGS__SRV__DETAIL__OS_CONFIG_SRV__FUNCTIONS_H_
#define MYMSGS__SRV__DETAIL__OS_CONFIG_SRV__FUNCTIONS_H_
...
/// Initialize srv/OSConfigSrv message.
/**
...
/// Finalize srv/OSConfigSrv message.
/**
...
/// Create srv/OSConfigSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mymsgs__srv__OSConfigSrv_Request__init().
...
/// Destroy srv/OSConfigSrv message.
/**
 * It calls
 * mymsgs__srv__OSConfigSrv_Request__fini()
...
/// Initialize array of srv/OSConfigSrv messages.
/**
...
/// Finalize array of srv/OSConfigSrv messages.
/**
 * It calls
 * mymsgs__srv__OSConfigSrv_Request__fini()
...
/// Create array of srv/OSConfigSrv messages.
/**
 * It allocates the memory for the array and calls
 * mymsgs__srv__OSConfigSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/OSConfigSrv messages.
/**
 * It calls
 * mymsgs__srv__OSConfigSrv_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mymsgs__srv__OSConfigSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mymsgs
...
/**
 * It calls
 * mymsgs__srv__OSConfigSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mymsgs
...
/**
 * It allocates the memory for the array and calls
 * mymsgs__srv__OSConfigSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mymsgs
...
/**
 * It calls
 * mymsgs__srv__OSConfigSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MYMSGS__SRV__DETAIL__OS_CONFIG_SRV__FUNCTIONS_H_
