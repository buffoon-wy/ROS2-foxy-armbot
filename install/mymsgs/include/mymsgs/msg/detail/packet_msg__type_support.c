...
#include <stddef.h>
#include "mymsgs/msg/detail/packet_msg__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember PacketMsg__rosidl_typesupport_introspection_c__PacketMsg_message_member_array[1] = {
  {
    ...
    offsetof(mymsgs__msg__PacketMsg, buf),  // bytes offset in struct
    NULL,  // default value
