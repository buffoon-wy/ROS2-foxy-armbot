...
#include <stddef.h>
#include "mymsgs/msg/detail/control__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  mymsgs__msg__Control__init(message_memory);
}

void Control__rosidl_typesupport_introspection_c__Control_fini_function(void * message_memory)
{
  mymsgs__msg__Control__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Control__rosidl_typesupport_introspection_c__Control_message_member_array[1] = {
  {
    "gpio",  // name
    ...
    offsetof(mymsgs__msg__Control, gpio),  // bytes offset in struct
    NULL,  // default value
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mymsgs, msg, Control)() {
