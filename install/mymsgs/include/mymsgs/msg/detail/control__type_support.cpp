...
{
  new (message_memory) mymsgs::msg::Control(_init);
}

void Control_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mymsgs::msg::Control *>(message_memory);
  typed_message->~Control();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Control_message_member_array[1] = {
  {
    "gpio",  // name
    ...
    offsetof(mymsgs::msg::Control, gpio),  // bytes offset in struct
...
{
  return &::mymsgs::msg::rosidl_typesupport_introspection_cpp::Control_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mymsgs, msg, Control)() {
  return &::mymsgs::msg::rosidl_typesupport_introspection_cpp::Control_message_type_support_handle;
}
