...
{
  new (message_memory) mymsgs::msg::Gpio(_init);
}

void Gpio_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mymsgs::msg::Gpio *>(message_memory);
  typed_message->~Gpio();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Gpio_message_member_array[3] = {
  {
    "time_boot_ms",  // name
    ...
    offsetof(mymsgs::msg::Gpio, time_boot_ms),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mymsgs::msg::Gpio, output),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mymsgs::msg::Gpio, input),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::mymsgs::msg::rosidl_typesupport_introspection_cpp::Gpio_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mymsgs, msg, Gpio)() {
  return &::mymsgs::msg::rosidl_typesupport_introspection_cpp::Gpio_message_type_support_handle;
}
