...
bool mymsgs__msg__heart__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mymsgs.msg._heart.Heart", full_classname_dest, 23) == 0);
  }
  mymsgs__msg__Heart * ros_message = _ros_message;
  {  // error_code
...
{
  /* NOTE(esteve): Call constructor of Heart */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mymsgs.msg._heart");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Heart");
