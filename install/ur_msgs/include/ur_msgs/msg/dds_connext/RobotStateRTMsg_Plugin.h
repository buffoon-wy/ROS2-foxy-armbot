...
#ifndef RobotStateRTMsg_Plugin_2138618408_h
#define RobotStateRTMsg_Plugin_2138618408_h
...
namespace ur_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define RobotStateRTMsg_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define RobotStateRTMsg_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define RobotStateRTMsg_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define RobotStateRTMsg_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define RobotStateRTMsg_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern RobotStateRTMsg_*
            ...
            RobotStateRTMsg_PluginSupport_copy_data(
                RobotStateRTMsg_ *out,
                const RobotStateRTMsg_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            RobotStateRTMsg_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                RobotStateRTMsg_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            RobotStateRTMsg_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                RobotStateRTMsg_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            RobotStateRTMsg_Plugin_new(void);

            NDDSUSERDllExport extern void
            RobotStateRTMsg_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* RobotStateRTMsg_Plugin_2138618408_h */
