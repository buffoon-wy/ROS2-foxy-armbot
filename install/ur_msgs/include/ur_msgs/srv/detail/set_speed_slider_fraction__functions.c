...
{
  ur_msgs__srv__SetSpeedSliderFraction_Request * msg = (ur_msgs__srv__SetSpeedSliderFraction_Request *)malloc(sizeof(ur_msgs__srv__SetSpeedSliderFraction_Request));
  if (!msg) {
    return NULL;
  }
...
ur_msgs__srv__SetSpeedSliderFraction_Request__Sequence__init(ur_msgs__srv__SetSpeedSliderFraction_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ur_msgs__srv__SetSpeedSliderFraction_Request *)calloc(size, sizeof(ur_msgs__srv__SetSpeedSliderFraction_Request));
    if (!data) {
      return false;
    }
...
{
  ur_msgs__srv__SetSpeedSliderFraction_Request__Sequence * array = (ur_msgs__srv__SetSpeedSliderFraction_Request__Sequence *)malloc(sizeof(ur_msgs__srv__SetSpeedSliderFraction_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  ur_msgs__srv__SetSpeedSliderFraction_Response * msg = (ur_msgs__srv__SetSpeedSliderFraction_Response *)malloc(sizeof(ur_msgs__srv__SetSpeedSliderFraction_Response));
  if (!msg) {
    return NULL;
  }
...
ur_msgs__srv__SetSpeedSliderFraction_Response__Sequence__init(ur_msgs__srv__SetSpeedSliderFraction_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ur_msgs__srv__SetSpeedSliderFraction_Response *)calloc(size, sizeof(ur_msgs__srv__SetSpeedSliderFraction_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ur_msgs__srv__SetSpeedSliderFraction_Response__Sequence * array = (ur_msgs__srv__SetSpeedSliderFraction_Response__Sequence *)malloc(sizeof(ur_msgs__srv__SetSpeedSliderFraction_Response__Sequence));
  if (!array) {
    return NULL;
  }
