...
#include "ur_msgs/srv/detail/set_payload__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ur_msgs::srv::SetPayload_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur_msgs::srv::SetPayload_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetPayload_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ur_msgs::srv::SetPayload_Request *>(
...
{
  return max_serialized_size_SetPayload_Request(full_bounded, 0);
}
...
{
  return &ur_msgs::srv::typesupport_fastrtps_cpp::_SetPayload_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const ur_msgs::srv::SetPayload_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_msgs::srv::SetPayload_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetPayload_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ur_msgs::srv::SetPayload_Response *>(
...
{
  return max_serialized_size_SetPayload_Response(full_bounded, 0);
}
...
{
  return &ur_msgs::srv::typesupport_fastrtps_cpp::_SetPayload_Response__handle;
}
...
{
  return &ur_msgs::srv::typesupport_fastrtps_cpp::_SetPayload__handle;
}
