...
bool ur_msgs__msg__digital__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_msgs.msg._digital.Digital", full_classname_dest, 28) == 0);
  }
  ur_msgs__msg__Digital * ros_message = _ros_message;
  {  // pin
...
{
  /* NOTE(esteve): Call constructor of Digital */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ur_msgs.msg._digital");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Digital");
