...
#include "ur_msgs/msg/analog__rosidl_typesupport_connext_cpp.hpp"
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const ur_msgs::msg::Analog & ros_message =
    *(const ur_msgs::msg::Analog *)untyped_ros_message;

  // create a respective connext dds type
  ur_msgs::msg::dds_::Analog_ * dds_message = ur_msgs::msg::dds_::Analog_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  ur_msgs::msg::Analog & ros_message =
    *(ur_msgs::msg::Analog *)untyped_ros_message;
...
{
  return &ur_msgs::msg::typesupport_connext_cpp::_Analog__handle;
}
