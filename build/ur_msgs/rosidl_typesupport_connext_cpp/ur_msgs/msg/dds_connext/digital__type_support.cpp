...
#include "ur_msgs/msg/digital__rosidl_typesupport_connext_cpp.hpp"
  ...
  ur_msgs::msg::Digital & ros_message)
{
  ...
  // member.name state
  ros_message.state =
    dds_message.state_ == DDS_BOOLEAN_TRUE;

  return true;
}

bool
to_cdr_stream__Digital(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const ur_msgs::msg::Digital & ros_message =
    *(const ur_msgs::msg::Digital *)untyped_ros_message;

  // create a respective connext dds type
  ur_msgs::msg::dds_::Digital_ * dds_message = ur_msgs::msg::dds_::Digital_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  ur_msgs::msg::Digital & ros_message =
    *(ur_msgs::msg::Digital *)untyped_ros_message;
...
{
  return &ur_msgs::msg::typesupport_connext_cpp::_Digital__handle;
}
