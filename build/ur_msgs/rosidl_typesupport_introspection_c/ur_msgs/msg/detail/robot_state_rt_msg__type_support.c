...
void RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_init_function(
...
void RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_fini_function(void * message_memory)
{
  ur_msgs__msg__RobotStateRTMsg__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_message_member_array[19] = {
  {
    "time",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_message_members = {
  "ur_msgs__msg",  // message namespace
  "RobotStateRTMsg",  // message name
  19,  // number of fields
  sizeof(ur_msgs__msg__RobotStateRTMsg),
  RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_message_member_array,  // message members
  RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_init_function,  // function to initialize message memory (memory has to be allocated)
  RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_message_type_support_handle = {
  0,
  &RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur_msgs, msg, RobotStateRTMsg)() {
  if (!RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_message_type_support_handle.typesupport_identifier) {
    RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &RobotStateRTMsg__rosidl_typesupport_introspection_c__RobotStateRTMsg_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
