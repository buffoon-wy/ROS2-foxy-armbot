...
#include "mymsgs/msg/detail/packet_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const mymsgs::msg::PacketMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mymsgs::msg::PacketMsg *>(
    untyped_ros_message);
...
{
  return &mymsgs::msg::typesupport_fastrtps_cpp::_PacketMsg__handle;
}
