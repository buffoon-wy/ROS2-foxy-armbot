...
#include "mymsgs/srv/detail/os_config_srv__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const mymsgs::srv::OSConfigSrv_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mymsgs::srv::OSConfigSrv_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OSConfigSrv_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mymsgs::srv::OSConfigSrv_Request *>(
...
{
  return max_serialized_size_OSConfigSrv_Request(full_bounded, 0);
}
...
{
  return &mymsgs::srv::typesupport_fastrtps_cpp::_OSConfigSrv_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const mymsgs::srv::OSConfigSrv_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mymsgs::srv::OSConfigSrv_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OSConfigSrv_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mymsgs::srv::OSConfigSrv_Response *>(
...
{
  return max_serialized_size_OSConfigSrv_Response(full_bounded, 0);
}
...
{
  return &mymsgs::srv::typesupport_fastrtps_cpp::_OSConfigSrv_Response__handle;
}
...
{
  return &mymsgs::srv::typesupport_fastrtps_cpp::_OSConfigSrv__handle;
}
