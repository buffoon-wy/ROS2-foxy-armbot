...
#include "mymsgs/msg/gpio__rosidl_typesupport_connext_cpp.hpp"
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mymsgs::msg::Gpio & ros_message =
    *(const mymsgs::msg::Gpio *)untyped_ros_message;

  // create a respective connext dds type
  mymsgs::msg::dds_::Gpio_ * dds_message = mymsgs::msg::dds_::Gpio_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mymsgs::msg::Gpio & ros_message =
    *(mymsgs::msg::Gpio *)untyped_ros_message;
...
{
  return &mymsgs::msg::typesupport_connext_cpp::_Gpio__handle;
}
