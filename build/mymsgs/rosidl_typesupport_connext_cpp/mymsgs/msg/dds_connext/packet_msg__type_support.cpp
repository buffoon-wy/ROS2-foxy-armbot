...
#include "mymsgs/msg/packet_msg__rosidl_typesupport_connext_cpp.hpp"
  ...
  mymsgs::msg::dds_::PacketMsg_ & dds_message)
{
  // member.name buf
  {
    ...
    for (size_t i = 0; i < size; i++) {
      dds_message.buf_[static_cast<DDS_Long>(i)] =
        ros_message.buf[i];
    }
  }
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mymsgs::msg::PacketMsg & ros_message =
    *(const mymsgs::msg::PacketMsg *)untyped_ros_message;

  // create a respective connext dds type
  mymsgs::msg::dds_::PacketMsg_ * dds_message = mymsgs::msg::dds_::PacketMsg_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mymsgs::msg::PacketMsg & ros_message =
    *(mymsgs::msg::PacketMsg *)untyped_ros_message;
...
{
  return &mymsgs::msg::typesupport_connext_cpp::_PacketMsg__handle;
}
