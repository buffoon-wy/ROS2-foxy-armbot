...
#ifndef Imu_Plugin_231391884_h
#define Imu_Plugin_231391884_h
...
namespace mymsgs {
    namespace msg {
        namespace dds_ {
            ...
            #define Imu_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Imu_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Imu_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Imu_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Imu_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Imu_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Imu_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Imu_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern void
            Imu_Plugin_delete(struct PRESTypePlugin *);
