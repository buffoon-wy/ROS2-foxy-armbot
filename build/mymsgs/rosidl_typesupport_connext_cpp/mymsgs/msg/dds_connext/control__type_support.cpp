...
#include "mymsgs/msg/control__rosidl_typesupport_connext_cpp.hpp"
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mymsgs::msg::Control & ros_message =
    *(const mymsgs::msg::Control *)untyped_ros_message;

  // create a respective connext dds type
  mymsgs::msg::dds_::Control_ * dds_message = mymsgs::msg::dds_::Control_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mymsgs::msg::Control & ros_message =
    *(mymsgs::msg::Control *)untyped_ros_message;
...
{
  return &mymsgs::msg::typesupport_connext_cpp::_Control__handle;
}
