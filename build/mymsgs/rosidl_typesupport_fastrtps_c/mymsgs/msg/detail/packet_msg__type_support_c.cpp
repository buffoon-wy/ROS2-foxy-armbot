...
#include "mymsgs/msg/detail/packet_msg__rosidl_typesupport_fastrtps_c.h"
...
using _PacketMsg__ros_msg_type = mymsgs__msg__PacketMsg;
...
static uint32_t _PacketMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mymsgs__msg__PacketMsg(
...
{
  return max_serialized_size_mymsgs__msg__PacketMsg(
    full_bounded, 0);
}
